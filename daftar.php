        ...
        <div class="row justify-content-center">
            ...
            <form action="" method="post">
                <div class="card-body">
                    ...
                    <div class="row">
                        <button type="submit" class = "btn btn-primary" name = "bntDaftar">DAFTAR</button>
                    </div>
...
if(isset($_POST['btnDaftar'])){
    ...
    $password=$_POST=password_hash($_POST['password'], PASSWORD_BCRYPT);

    $query = mysqli_query($conn, "INSERT INTO tb_login VALUES('$username', $password)");
